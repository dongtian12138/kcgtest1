...
from kcg_connector.grasp.carts_v2.models import CandidateSeed, file_sha256
...
def main() -> int:
    ...
    root, feature = args.repository_root.resolve(), _resolve(
        args.repository_root.resolve(), args.feature_report)
    ...
    result = {
        ...
        "refinement_source_sha256": file_sha256(
            root / "src/kcg_connector/kcg_connector/grasp/carts_v2/"
