...
- 当前 B-V3 控制器：[`kcg_connector/grasp/moment_constrained_support_transfer.py`](kcg_connector/grasp/moment_constrained_support_transfer.py)
- 当前 B-V3 配置：[`config/d38999_moment_constrained_support_transfer_v1.yaml`](config/d38999_moment_constrained_support_transfer_v1.yaml)
- B-V3 定向测试：[`test/test_moment_constrained_support_transfer.py`](test/test_moment_constrained_support_transfer.py)
...
| `kcg_connector/grasp/` | 当前三指抓取及支撑转移控制 |
...
- 正式硬门保持原始传感器原点 `8 N / 0.30 N·m`，不得用滤波延迟或离线重算替代。
