...
def _execute_held_plug_path(
    ...
    for arm in arm_states:
        ...
        if observer is not None:
            ...
            measured=observer.control_moments(stepper.latest[0],stepper.latest[2][8:],
                stepper.step_index,float(dynamic['physics_dt_s']))
...
def _capture_rgbd(
    *,
    ...
    return {
        ...
        "warmup_render_frames": int(warmup_frames),
        "render_subframes_per_frame": int(rt_subframes),
