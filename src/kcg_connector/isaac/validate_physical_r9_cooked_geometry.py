...
"""Fail closed on PhysX-cooked geometry drift in the physical-r9 asset.
...
PASS_BANNER = "ISAAC PHYSICAL R9 COOKED GEOMETRY PASSED"
FAIL_BANNER = "ISAAC PHYSICAL R9 COOKED GEOMETRY FAILED"
...
def _run() -> dict[str, Any]:
    ...
    if stage is None:
        raise RuntimeError("authorized r9 asset could not be opened")
    ...
    if len(mesh_paths) != expected_mesh_count:
        raise RuntimeError("trusted r9 mesh inventory does not close")
